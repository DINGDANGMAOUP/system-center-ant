...
module.exports = {
  ...
  systemName: 'System Center',         //系统名称
  copyright: '2021 kuroneko 出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://github.com/DINGDANGMAOUP', icon: 'github'},
    {link: 'https://kuroneko.fun', name: 'kuroneko'},
    {link: 'mailto:964621334@qq.com', icon: 'mail'}
  ],
}
